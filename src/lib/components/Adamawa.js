    ...
    return (
      <div className="App">
        <a href="javascript:void(0)" class="tip">
          <span id={this.state.id} ref={this.myRef1}>Adamawa State</span>
          <svg
          ...
          >
            <rect
              ...
              stroke-width="0.989824373376452"
            ...
            <path
              ...
              class="sm_state_NGA2881"
              opacity="1"
              stroke-opacity="1"
              stroke-width="0.6852059224698488"
            ...
            <text
              ...
              stroke="none"
              fill="#d5ddec"
              style={{"-webkit-tap-highlight-color": "rgba(0, 0, 0, 0)", "text-anchor": "middle", font: "bold 22px Arial", cursor: "pointer", opacity: "1"}}
              stroke-width="0"
              font-size="22px"
              font-weight="bold"
              font-family="Arial"
