...
const Anambra = (props: StateProps) => {
  ...
  return (
    <div className="App">
      <a href="javascript:void(0)" className="tip">
        {(showRenderData) && <span id={id} ref={myRef1}>Anambra State</span>}
        <svg
          height={props.height}
          version="1.1"
          width="369.2"
