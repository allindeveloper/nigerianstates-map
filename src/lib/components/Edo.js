    ...
    return (
      <div className="App">
        <a href="javascript:void(0)" className="tip">
          {(showRenderData)&&<span id={this.state.id} ref="myRef1">Edo State</span>}
          <svg
...
Edo.propTypes = {
  ...
  showRenderData:PropTypes.string,
